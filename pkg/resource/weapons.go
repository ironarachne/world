...
func getWeapons() []Pattern {
	producer, _ := profession.ByName("weaponsmith")
	...
	patterns := []Pattern{
		...
		{
			Name:         "dart",
			NameTemplate: "{{.MainMaterial}} dart",
			Description:  "a dart",
			Tags: []string{
				"weapon",
			},
		...
		{
			Name:         "sling",
			NameTemplate: "{{.MainMaterial}} sling",
			Description:  "a sling",
			Tags: []string{
				"weapon",
			},
		...
		{
			Name:         "whip",
			NameTemplate: "{{.MainMaterial}} whip",
			Description:  "a whip",
			Tags: []string{
				"weapon",
			},
		...
		{
			Name:         "blowgun",
			NameTemplate: "{{.MainMaterial}} blowgun",
			Description:  "a blowgun",
			Tags: []string{
				"weapon",
			},
			Profession: producer,
